...
//				System.out.println(p.getReadMethod().toString());
//				System.out.println(p.getReadMethod().toGenericString());
//				for (Annotation a : p.getReadMethod().getAnnotations())
//					System.out.println("RdAnnotation : " + a.toString());
//				//System.out.println(p.getWriteMethod().toGenericString());
//				///for (Annotation a : p.getWriteMethod().getAnnotations())
//				//	System.out.println("WrAnnotation : " + a.toString());
